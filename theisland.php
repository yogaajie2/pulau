...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Get the most of your visit. forget your problems, find new fresh inspirations. Take a deep breath and start exploring. Book our Bungalow now.">
    ...
    <title>The Island | Sunset Bungalow Pramuka Island</title>
  </head>
  <body>
    <div class="site-container">
        <div class="site-pusher">
            ...
            <div class="site-content">
                <div class="jumbotron jumbotron-fluid text-center islandJumbotron">
                    <h1>THE ISLAND</h1>
                </div>
                ...
                <div class="container-fluid topContent">
                    <div class="row contentRow">
                        <div class="col-md-3 contentCol contentColHistory text-center">
                    ...
                    <div class="row my-4">
                        <div class="col">
                            ...
                            <div class="row my-4">
                                <div class="col-md">
                                    <div class="card">
                                        <img class="card-img-top" src="img/cards/sunset.jpg" alt="Stunning Sunset in Pramuka Island">
                                        <div class="card-body">
                                ...
                                <div class="col-md">
                                    <div class="card">
                                        <img class="card-img-top" src="img/cards/pulau.jpg" alt="Beautiful Beach in Pramuka Island">
                                        <div class="card-body">
                                            <h3 class="card-title">Beautiful Spots</h3>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="theactivities.php" class="card-link"><h3>Read More</h3></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8">
